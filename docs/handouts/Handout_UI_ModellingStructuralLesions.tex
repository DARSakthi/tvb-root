...
\newthought{We can now try} to evaluate the difference between the activity generated by both connectivty matrices. We'd like to see how the structural diffrences alter the stability plane of our system. 
...
\begin{simulation}
  ...
  \item Select a point in the resulting \underline{Parameter Space Discrete} map, for instance the one with \underline{conduction speed} equalt to \textbf{\unitfrac[7]{mm/ms}} and \underline{global coupling strength} \textbf{a}$\mathbf{=}$\textbf{\unit[0.008][au]}. Tag the time-series (e.g \underline{Datatype Tag 3}: \textbf{ThisPoint}). 
...
\begin{enumerate}
  ...
  \item Select the \textbf{control connectivity}, \textbf{long range linear coupling} with \underline{a range} between \textbf{0.002} and \textbf{0.02}. Set the \underline{conduction speed} in the range \textbf{\unitfrac[1]{mm/ms}} and \textbf{\unitfrac[10]{mm/ms}}.
